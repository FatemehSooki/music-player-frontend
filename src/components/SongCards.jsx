...
export default function SongCards({ src, title, artist, audio, duration, index, allSongs, artistCover }) {
  ...
  return (
    <div onClick={handleClick} className='w-52 bg-zinc-800 rounded-2xl p-4 overflow-hidden cursor-pointer transition-all duration-300 hover:bg-zinc-800 hover:scale-105 m-3'>
      ...
      <h4 className='mt-1 text-sm text-zinc-400 truncate'>
        {artist}
      </h4>
